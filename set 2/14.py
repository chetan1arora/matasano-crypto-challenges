...
cipher = AES.new(bytes(16),AES.MODE_CBC)

decrypt_iv = cipher.iv
decrypt_cipher = AES.new(bytes(16),AES.MODE_CBC,decrypt_iv)
print(bytes([i for i in range(16)]))
...
test = profile_for("ou@hoe.com0123456789abcdef0123456789abcdef")
